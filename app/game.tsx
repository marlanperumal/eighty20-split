...
export default function Game() {
  ...
  function drawLine(ctx: CanvasRenderingContext2D, start: Dot, end: Dot) {
  ...
  function extendLine(start: Dot, end: Dot) {
  ...
  function calculateSplit(start: Dot, end: Dot) {
  ...
  }, [dots, lineStart, lineEnd, isDrawing]);
